...
public enum CountryCode {
	...
	@JsonCreator
	@NotBlank
	@Length(max = 2, min = 2, message = "CntCode in Export Details should be https://docs.cleartax.in/cleartax-docs/e-invoicing-api/e-invoicing-api-reference/resources-and-master/country-code-master")
	...
	public static Optional<CountryCode> fromText(String text) {
